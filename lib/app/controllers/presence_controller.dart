...
class PresenceController extends GetxController {
  ...
  firstPresence(
    ...
    CustomAlertDialog.showPresenceAlert(
      title: "Apakah Anda Ingin check in?",
      message:
          "Anda perlu mengonfirmasi sebelum Anda dapat melakukan kehadiran sekarang",
      onCancel: () => Get.back(),
      onConfirm: () async {
  ...
  checkinPresence(
    ...
    CustomAlertDialog.showPresenceAlert(
      ...
      onConfirm: () async {
        ...
        Get.back();
        CustomToast.successToast("Berhasil", "success check in");
      },
    );
  }
  ...
  checkoutPresence(
    ...
    CustomAlertDialog.showPresenceAlert(
      ...
      onConfirm: () async {
        ...
        Get.back();
        CustomToast.successToast("Berhasil", "success check out");
      },
    );
  }
      ...
      if (todayDoc.exists == true) {
        ...
        if (dataPresenceToday?["keluar"] != null) {
          ...
          CustomToast.successToast(
              "Berhasil", "Anda sudah berhasil check in dan check out");
        } else {
